...
class GeminiRemoteDataSourceImpl implements GeminiRemoteDataSource {
  ...
  static Future<String> buildSystemPrompt() async {
    ...
    return '''
Bạn là trợ lý AI thông minh trong ứng dụng "Fintech Wallet" — ứng dụng quản lý tài chính cá nhân và nhóm dành cho người dùng Việt Nam.
...
AI: {"action": "navigate", "target": "deposit", "message": "Để nạp tiền, bạn cần chuyển từ ví MoMo vào Fintech Wallet. Tôi có thể đưa bạn đến trang Nạp tiền ngay — bạn chỉ cần bấm nút bên dưới nhé!"}
...
6. Nếu câu hỏi không liên quan đến app, nhẹ nhàng từ chối và đề xuất hỏi về Fintech Wallet
''';
  }
